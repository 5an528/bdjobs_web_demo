...
JobSearch = driver.find_element_by_id('txtKeyword').send_keys('IT')
time.sleep(10)

Category = driver.find_element_by_id('qOT').click()
time.sleep(5)

CategoryName = driver.find_element_by_xpath('//*[@id="qOT"]/option[5]').click()
time.sleep(5)

search = driver.find_element_by_xpath(
    '//*[@id="main"]/div/div[1]/div/div[1]/form/input[2]').click()
time.sleep(5)
